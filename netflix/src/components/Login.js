...
const Login = () => {
  ...
  return (
    <div>
      ...
      <form onSubmit={getInputData} className="className='flex flex-col w-3/12 p-12 my-36 left-0 right-0  mx-auto items-center justify-center absolute rounded-md bg-black opacity-90">
        ...
        <div className=" flex flex-col">

          {
            ...
            !isLogin && <input value={fullName} onChange={(e) => setFullName(e.target.value)}
